                        ...
                        <div class="wideget-user-tab wideget-user-tab3">
                            <div class="tab-menu-heading">
                                <div class="tabs-menu1">
                                    <ul class="nav">
                                        <li><a href="#tab-5" data-toggle="tab" class="active">Information</a></li>
                                        <li class=""><a href=" #tab-1" class="" data-toggle=" tab">Content</a></li>
                                        <li><a href="#tab-3" data-toggle="tab" class="">Products</a></li>
													              <li><a href=" #tab-4" data-toggle="tab" class=""><i class=" icon icon-lock text-muted mr-1"></i>Community</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div
                            class="tab-content border-left border-right border-top br-tr-3 border-bottom br-br-3 br-bl-3 p-5 bg-white mb-4">
                            ...
                            <div class="tab-pane" id="tab-1">
                                ...
                                <div class="mb-4">
                                    <p>Killington odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti
                                        atcorrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non
                                            ...
                                            <table class="table table-bordered w-100 m-0 text-nowrap ">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="font-weight-bold">Colors :</span> Red , pink, Gray
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="font-weight-bold">Power Windows :</span> Available
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
