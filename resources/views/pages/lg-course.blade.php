													...
													<div class="card overflow-hidden">
														<div class="item-card9-img">
															...
															<div class="item-card9-imgs">
																<a class="link" href="{{route('lg-course-detail')}}"></a>
																<img src="../assets/images/media/j3.png" alt="img" class="cover-image">
															</div>
															<div class="item-card9-icons">
																<a href="{{route('lg-course-detail')}}" class="item-card9-icons1 wishlist active"> <i class="fa fa fa-heart-o"></i></a>
															</div>
															<div class="item-overly-trans">
																<span><a href="{{route('lg-course-detail')}}" class="bg-success">New</a></span>
															</div>
														</div>
